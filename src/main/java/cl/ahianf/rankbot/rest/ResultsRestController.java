...
public class ResultsRestController {
    ...
    // guarda en db/results
    public void calculateElo() {
        logger.info("Inicio de calculo Elo");
        ...
        for (Artist artist : all) {
            ...
            List<Song> listaCanciones =
                    songRepository.findAllByArtistOrderBySongIdAsc(
        ...
        logger.info("Fin de calculo Elo");
    }
}
