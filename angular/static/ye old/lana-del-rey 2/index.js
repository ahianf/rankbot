...
function getMatch() {
    ...
    // fetch('http://158.101.8.82/api/match/death-grips')
    fetch('https://rankbot.me/api/match/lana-del-rey')
...
function postResult(matchId, vote) {
    ...
    let url = "https://rankbot.me/api/match/";
    // let url = "http://158.101.8.82/api/match/";
